...
const navegacion = [
  { name: 'Inicio', href: 'http://localhost:3000/adminhome', current: false },
  { name: 'Carrito', href: 'http://localhost:3000/carrito-admin', current: true },
                      ...
                      <Menu.Item>
                        {
                          ({ active }) => (
                            <a
                              href="http://localhost:3000/insertproduct"
                              className={classNames(active ? 'bg-gray-100' : '', 'block px-4 py-2 text-sm text-gray-700')}>
                              Nuevo Producto
                            </a>
                          )
